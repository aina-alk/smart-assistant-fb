/**
 * Secretaire Dashboard Page - Placeholder
 */

import { Card, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Construction, Calendar, Users, ClipboardList } from 'lucide-react';

const plannedFeatures = [
  {
    title: 'Agenda',
    description: 'Gestion des rendez-vous et planification',
    icon: Calendar,
  },
  {
    title: 'Patients',
    description: 'Accueil et gestion administrative des patients',
    icon: Users,
  },
  {
    title: 'Tâches',
...
export default function SecretaireDashboardPage() {
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold tracking-tight">Espace Secrétaire</h2>
