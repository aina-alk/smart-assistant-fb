/**
 * Page de connexion - Google OAuth + Email Link (passwordless)
 */
          ...
          <TabsContent value="email" className="space-y-4 mt-4">
            {emailLinkSent ? (
              <div className="text-center space-y-4 py-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Un lien de connexion a été envoyé à <span className="font-medium">{email}</span>
                  </p>
                ...
                <Button
                  ...
                  onClick={() => {
                    setEmail('');
                    // Reset emailLinkSent state by sending new email
                  }}
                  className="mt-2"
                >
              ...
              <form onSubmit={handleEmailLinkSignIn} className="space-y-4">
                ...
                <Button
                  type="submit"
                  disabled={emailLinkLoading || !email}
