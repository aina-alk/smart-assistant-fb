...
export type UserStatus = 'pending_call' | 'in_review' | 'pending_callback' | 'pending_info' | 'approved' | 'rejected' | 'suspended';
...
export type AuditAction = 'user_created' | 'user_approved' | 'user_rejected' | 'status_changed' | 'role_changed' | 'user_suspended';
