...
exports.getAdminStatusChangeTemplate = getAdminStatusChangeTemplate;
...
function getAdminStatusChangeTemplate(user, userId, oldStatus, newStatus, performedBy) {
    ...
    return {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${config_1.config.app.adminUrl}/users/${userId}"
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
          <p style="color: #6b7280; margin: 0; font-size: 12px;">
            Email envoyé automatiquement par le système ${config_1.config.app.name}
          </p>
        </div>
      </div>
    `,
...
//# sourceMappingURL=admin-status-change.js.map